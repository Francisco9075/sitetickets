...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM contas WHERE email = '$email' AND senha = '$password'";
...
<body
  ...
  <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
    <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
          ...
          <div>
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Introduza o seu e-mail e password para fazer login!
              </p>
            </div>
            ...
            <div x-show="showError" 
                 ...
                 class="mb-4 p-4 rounded-lg bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-800">
            ...
            <div>
              ...
              <form @submit.prevent="handleLogin()">
                <div class="space-y-5">
                  ...
                  <div>
                    <button type="submit"
                      class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg btn-lgin shadow-theme-xs hover:bg-brand-600">
                      Login
                    </button>
                  </div>
                </div>
      ...
      <div class="relative items-center hidden w-full h-full bg-greymin dark:bg-white/5 lg:grid lg:w-1/2">
        <div class="flex items-center justify-center z-1">
          <!-- ===== Common Grid Shape Start ===== -->
          <include src="./partials/common-grid-shape.html"></include>

          <!-- Bloco principal -->
          <div class="flex flex-col items-center max-w-xs text-center space-y-3">
            <!-- Logo + iTicket lado a lado -->
            <div class="flex items-center space-x-2">
              <img src="./images/logo/logo-icon.svg" alt="logo" class="w-8 h-8" />
              <h1 class="text-2xl font-semibold text-gray-800 dark:text-white text-lgin">iTicket</h1>
            </div>

            <!-- Texto abaixo -->
            <p class="text-gray-400 dark:text-white/60">
              Dashboard para vocês gestores de eventos.
            </p>
          </div>
        </div>
